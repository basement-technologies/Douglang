...
fn match_token(s: &str) -> Option<Token> {
    match s {
		// Dougs
        "DougDoug" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DougDoug: Published Author (formerly)" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DouglasDouglas" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Gloudas (formerly)" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Davey Wreden's Brother" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Diablo the Cheater" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DogDog" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"BaldBald" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DougDougW (formerly)" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DougeDouge" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"LateLate" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Pee Pants Doug" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Sheep kisser" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Shit King" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"That guy" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"The Man in the Chair" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"The Rig Lord" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"unsafe man" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"World's Biggest Baldest Virgin" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"A.I Boy" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"100,002" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Douglas Scott Memoir" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Cletus" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DaguDagu" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Man who digs in past tense" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DJ Fucks mugmugs" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DJ Mugfucker" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Double-D" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Douglass" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"DrugDrug" => Some(Token::KeyWord(KeyWord::DougChain(1))),
		"Dong" => Some(Token::KeyWord(KeyWord::DougChain(1))),

        // Keywords
        "tts" => Some(Token::KeyWord(KeyWord::Tts)),
        "ttss" => Some(Token::KeyWord(KeyWord::Ttss)),
        ...
        "xoug" => Some(Token::Operator(Operator::BinaryXor)),
        "oug" => Some(Token::Operator(Operator::BinaryOr)),
        "aoug" => Some(Token::Operator(Operator::BinaryAnd)),

        "xuoD" => Some(Token::Operator(Operator::LogicalAnd)),
        "ouoD" => Some(Token::Operator(Operator::LogicalOr)),
        "auoD" => Some(Token::Operator(Operator::LogicalXor)),
